...
// */
//@Data
//public class DBFReader1 implements Iterable<List<DBFResult>> {
//
//    final private String filename;
//    final private Charset charset;
//    final private boolean showDeletedRows;
//
//    public DBFReader1(String filename, Charset charset, boolean showDeletedRows) {
//        this.filename  =filename;
//        this.charset = charset;
//        this.showDeletedRows = showDeletedRows;
//    }
//
//    public DBFReader1(String filename, Charset charset) {
